...
def processArchive():
    fields = ['NOME_DO_SU','Semana','Municipio','ANF','BSC/RNC','Station ID','BTS/NodeB/ENodeB','Banda','Celula','Tecnologia','VOLUME_DADOS_DLUL_ALLOP(Mbyte)','TRAFEGO_VOZ_TIM','Peso_ACD','Peso_DROP_VOZ','Peso_DROP_DADOS','Peso_DISP','Peso_ACV']
    fields2 = ['NOME_DO_SU','Semana','Municipio','ANF','BSC/RNC','Station ID','BTS/NodeB/ENodeB','Banda','Celula','Tecnologia','VOLUME_DADOS_DLUL_ALLOP(Mbyte)','TRAFEGO_VOZ_TIM','Peso_ACD','Peso_DROP_VOZ','Peso_DROP_DADOS','Peso_DISP','Peso_ACV']
        ...
        for ref_Index in col_ref_List:
          ...
          for dia in col_Dia:
            for site in col_Site:
              frameSI2.loc[(frameSI2['Semana'] == dia) & (frameSI2['BTS/NodeB/ENodeB'] == site),[tec+'_Peso_ACD_'+ref]] = frameSI2.loc[frameSI2['Semana']== dia,'Peso_ACD'].astype(float).sum()
            '''
