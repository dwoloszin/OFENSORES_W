...
ref1 = ['ANF']
ref2 = ['2G','3G','4G']
ref3 = ['_ACD_','_DROP_VOZ_','_DROP_DADOS_','_DISP_','_THROU_USER_','_ACV_','_VOLUME_DADOS_DLUL_ALLOP(Mbyte)_']
...
for i in ref1:
  ...
  frameSI = frameSI.astype(str)
  lista1 = ['2G_VOLUME_DADOS_DLUL_ALLOP(Mbyte)_' + ref1[0],'3G_VOLUME_DADOS_DLUL_ALLOP(Mbyte)_' + ref1[0],'4G_VOLUME_DADOS_DLUL_ALLOP(Mbyte)_' + ref1[0],'OffLoad4G']
  for i in lista1:
    frameSI[i] = [x.replace('.', ',') for x in frameSI[i]]
