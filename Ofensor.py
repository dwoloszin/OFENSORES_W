...
def processArchive(Agregacao,periodo):
    fields = [Agregacao,periodo,'Municipio','ANF','BSC/RNC','Station ID','BTS/NodeB/ENodeB','Banda','Celula','Tecnologia','VOLUME_DADOS_DLUL_ALLOP(Mbyte)','TRAFEGO_VOZ_TIM','Peso_ACD','Peso_DROP_VOZ','Peso_DROP_DADOS','Peso_DISP','Peso_ACV']
    fields2 = [Agregacao,periodo,'Municipio','ANF','BSC/RNC','Station ID','BTS/NodeB/ENodeB','Banda','Celula','Tecnologia','VOLUME_DADOS_DLUL_ALLOP(Mbyte)','TRAFEGO_VOZ_TIM','Peso_ACD','Peso_DROP_VOZ','Peso_DROP_DADOS','Peso_DISP','Peso_ACV']
        ...
        for ref_Index in col_ref_List:
          ...
          for dia in col_Dia:
            ...
            '''
              ...
              frameSI2.loc[(frameSI2[periodo] == dia),[tec+'_VOLUME_DADOS_DLUL_ALLOP(Mbyte)_'+ref]] = frameSI2.loc[frameSI2[periodo]== dia,'VOLUME_DADOS_DLUL_ALLOP(Mbyte)'].astype(float).sum()
          ...
          #dropList = ['VOLUME_DADOS_DLUL_ALLOP(Mbyte)','TRAFEGO_VOZ_TIM','ACD_DEN','ACD_NUM','DROP_VOZ_DEN','DROP_VOZ_NUM','DROP_DADOS_DEN','DROP_DADOS_NUM','DISP_DEN','DISP_NUM','THROU_USER_DEN','THROU_USER_NUM','ACV_DEN','ACV_NUM']
